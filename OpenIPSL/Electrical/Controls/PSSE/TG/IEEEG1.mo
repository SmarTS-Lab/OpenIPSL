...
model IEEEG1
  ...
  OpenIPSL.NonElectrical.Continuous.LeadLag imLeadLag(
    ...
    T1=T_2,
    T2=T_1,
    y_start=0) annotation (Placement(transformation(extent={{-144,0},{-128,16}})));
  ...
  OpenIPSL.NonElectrical.Continuous.SimpleLag imSimpleLag3(
    K=1,
    T=T_7,
    y_start=P0) annotation (Placement(transformation(extent={{102,0},{118,16}})));
  ...
  Modelica.Blocks.Sources.Constant Pref(k=P0) "Power reference " annotation (Placement(transformation(extent={{-144,34},{-128,50}})));
  Modelica.Blocks.Math.Add3 add3_1(k2=-1, k3=-1) annotation (Placement(transformation(extent={{-112,0},{-96,16}})));
  Modelica.Blocks.Math.Gain gain(k=1/T_3) annotation (Placement(transformation(extent={{-90,0},{-74,16}})));
  Modelica.Blocks.Nonlinear.Limiter limiter(uMax=U_o, uMin=U_c) annotation (Placement(transformation(extent={{-68,0},{-52,16}})));
  ...
  Modelica.Blocks.Math.Add add annotation (Placement(transformation(extent={{58,52},{70,64}})));
  Modelica.Blocks.Math.Add add1 annotation (Placement(transformation(extent={{58,-48},{70,-36}})));
  Modelica.Blocks.Math.Add add2 annotation (Placement(transformation(extent={{98,-48},{110,-36}})));
  Modelica.Blocks.Math.Add add3 annotation (Placement(transformation(extent={{98,52},{110,64}})));
...
equation
  ...
  annotation (
    Diagram(coordinateSystem(extent={{-140,-80},{160,80}}, preserveAspectRatio=false)),
    Icon(coordinateSystem(extent={{-140,-80},{160,80}}, preserveAspectRatio=true), graphics={Rectangle(extent={{-140,80},{160,-80}}, lineColor={0,0,255}),Text(
          extent={{-122,18},{-68,-18}},
          lineColor={0,0,255},
