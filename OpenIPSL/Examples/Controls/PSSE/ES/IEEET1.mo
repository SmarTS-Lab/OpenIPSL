...
model IEEET1 "SMIB system with one load and GENROE model"
  ...
  extends iPSL.Examples.SMIBpartial(gENCLS(M_b=100000000));
  iPSL.Electrical.Machines.PSSE.GENROE gENROE(
    ...
    P_0=40000000,
    Q_0=5416582,
    v_0=1) annotation (Placement(transformation(extent={{-108,-20},{-68,20}})));
...
equation
  ...
  connect(iEEET2_1.VOTHSG, const.y) annotation (Line(points={{-74,-37.0556},{
          -55.3333,-37.0556},{-55.3333,-40},{-49,-40}},
                                               color={0,0,127}));
  ...
  connect(gENROE.XADIFD, iEEET2_1.XADIFD) annotation (Line(points={{-66.4,-18},
          {-62,-18},{-62,-66},{-97.2,-66},{-97.2,-57.7111}},                                                                      color={0,0,127}));
  annotation (
