...
equation
  ...
  connect(pSS2A.V_S2, gENROE.PELEC) annotation (Line(points={{-155.4,-38},{-158,
          -38},{-158,-48},{-46,-48},{-46,6},{-58,6}},
                                                 color={0,0,127}));
  connect(pSS2A.V_S1, gENROE.SPEED) annotation (Line(points={{-155.4,-34},{-158,
          -34},{-158,30},{-44,30},{-44,14},{-58,14}},
                                                 color={0,0,127}));
