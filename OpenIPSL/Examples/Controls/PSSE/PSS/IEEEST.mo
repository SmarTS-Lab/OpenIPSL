...
equation
  ...
  connect(eSST1A.VUEL3, eSST1A.VUEL2) annotation (Line(points={{-90.4805,
          -89.9958},{-90.4805,-110},{-82.713,-110},{-82.713,-89.9917}},
                                                              color={0,0,127}));
  connect(const2.y, eSST1A.VOEL) annotation (Line(points={{-41,-140},{-74.9,-140},
          {-74.9,-90}}, color={0,0,127}));
  connect(eSST1A.EFD, gENROE.EFD) annotation (Line(points={{-111.3,-73.3333},{
          -116,-73.3333},{-116,-10},{-106,-10}},
                                            color={0,0,127}));
  connect(eSST1A.VT, gENROE.ETERM) annotation (Line(points={{-58.0325,-69.1875},
          {-54,-69.1875},{-54,-6},{-60,-6}}, color={0,0,127}));
  connect(eSST1A.EFD0, gENROE.EFD0) annotation (Line(points={{-58,-84.1667},{
          -52,-84.1667},{-52,-10},{-60,-10}},
                                          color={0,0,127}));
  connect(eSST1A.XADIFD, gENROE.XADIFD) annotation (Line(points={{-95.7,
          -89.6667},{-50,-89.6667},{-50,-18},{-60.4,-18}},
                                                 color={0,0,127}));
  connect(iEEEST.V_CT, gENROE.ETERM) annotation (Line(points={{-95.7667,-35},{
          -102,-35},{-102,-28},{-54,-28},{-54,-6},{-60,-6}},
                                                        color={0,0,127}));
  connect(iEEEST.V_S, gENROE.PELEC) annotation (Line(points={{-95.7667,-41},{
          -102,-41},{-102,-52},{-56,-52},{-56,6},{-60,6}},
                                                      color={0,0,127}));
