...
equation
  ...
  connect(generator.PMECH0, HYGOV.PMECH0) annotation (Line(points={{-75,5},{-52,
          5},{-52,45.7778},{-63.5833,45.7778}},
                                     color={0,0,127}));
  connect(generator.SPEED, HYGOV.SPEED) annotation (Line(points={{-75,7},{-58,7},
          {-58,28.6667},{-63.5833,28.6667}},
                                  color={0,0,127}));
  connect(HYGOV.PMECH, generator.PMECH) annotation (Line(points={{-100.792,
          36.4444},{-110,36.4444},{-110,5},{-98,5}},
                                      color={0,0,127}));
  connect(SCRX.EFD, generator.EFD) annotation (Line(points={{-104.9,-35.7778},{
          -110,-35.7778},{-110,-5},{-98,-5}}, color={0,0,127}));
  connect(generator.ETERM, SCRX.ECOMP) annotation (Line(points={{-75,-3},{-50,
          -3},{-50,-35.7778},{-68,-35.7778}},
                                          color={0,0,127}));
  connect(generator.XADIFD, SCRX.XADIFD) annotation (Line(points={{-75.2,-9},{
          -58,-9},{-58,-18.3556},{-94.1,-18.3556}},
                                              color={0,0,127}));
