...
equation
  ...
  connect(pwLine4.p, bus2.p) annotation (Line(points={{-34,15},{-40,15},{-40,
          11.8063},{-46.7243,11.8063}}, color={0,0,255}));
  ...
  connect(bus3.p, PV11.p) annotation (Line(points={{5,12.1033},{15,12.1033},{15,
          12.1033},{19,12.1033}}, color={0,0,255}));
  ...
  connect(bus4.p, pwFault1.p) annotation (Line(points={{-3.3112,-30},{5,-30},{5,
          -57.3},{8.33333,-57.3}}, color={0,0,255}));
