...
model SolarPVtest
  ...
  iPSL.Electrical.Solar.PSAT.ConstantPQPV.PV1 PV11(
    ...
    angle_0=-0.0000253046024029618,
    Q_0=0.3) annotation (Placement(visible=true, transformation(
        origin={60,0.1033},
  ...
  Electrical.Branches.PwLine      pwLine4(
    ...
    X=0.1) annotation (Placement(visible=true, transformation(
        ...
        extent={{-3,-2},{3,2}},
        rotation=0)));
  Electrical.Machines.PSAT.ThirdOrder.Order3      order31(
    Sn=20,
    V_b=400,
    V_0=1,
    angle_0=0,
  ...
  Electrical.Buses.Bus      bus3 annotation (Placement(visible=true, transformation(
        ...
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  Electrical.Buses.Bus      bus4 annotation (Placement(visible=true, transformation(
        origin={40.6888,-40},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  ...
  Electrical.Loads.PSAT.LOADPQ      pwLoadPQ2(
    ...
    Q_0=6)     annotation (Placement(visible=true, transformation(
        ...
        extent={{-5,-5},{5,5}},
        rotation=90)));
  inner Electrical.SystemBase      SysData annotation (Placement(transformation(extent={{-100,80},
            {-50,100}})));
equation
  ...
  connect(pwLine2.n, bus2.p) annotation (Line(points={{-16.5,10},{-4,10},{-4,
          -0.0969},{0.1378,-0.0969}}, color={0,0,255}));
  ...
  connect(pwLinewithOpening1.p, bus2.p) annotation (Line(points={{16.5,-10},{4,
          -10},{4,-0.0969},{0.1378,-0.0969}}, color={0,0,255}));
  ...
  connect(bus3.p, PV11.p) annotation (Line(points={{40,0.1033},{45,0.1033},{49,
          0.1033}}, color={0,0,255}));
