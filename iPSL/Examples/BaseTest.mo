...
equation
  connect(pwLine2.p, pwLine1.p) annotation (Line(points={{13,10},{8,10},{8,-10},
          {13,-10}}, color={0,0,255}));
  connect(pwLine2.n, pwLine1.n) annotation (Line(points={{27,10},{32,10},{32,
          -10},{27,-10}}, color={0,0,255}));
  ...
  connect(bus3.p, pwLoadPQ2.p) annotation (Line(points={{80,-10},{87.3966,-10},
          {87.3966,-10.2889}}, color={0,0,255}));
