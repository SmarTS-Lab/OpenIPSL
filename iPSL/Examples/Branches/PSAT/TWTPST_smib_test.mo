...
model TWTPST_smib_test
  ...
  iPSL.Electrical.Loads.PSAT.LOADPQ lOADPQ2(Q_0=0.001, P_0=0.03) annotation (Placement(transformation(extent={{8,-52},
            {28,-32}})));
  ...
  iPSL.Electrical.Buses.InfiniteBus infiniteBus(V_0=1, angle_0=0) annotation (Placement(transformation(extent={{-100,
            -50},{-120,-30}})));
  ...
  iPSL.Electrical.Loads.PSAT.LOADPQ_variation lOADPQ1(
    ...
    t_end_2=0,
    dP2=0,
    dQ2=0)    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=90,
        origin={126,0})));
...
equation
  ...
  connect(infiniteBus.p, order2_1.p) annotation (Line(
      points={{-99,-40},{-98,-40},{-98,0.04964},{-101,0.04964}},
      color={0,0,255},
      smooth=Smooth.None));
  ...
  connect(lOADPQ2.p, pwLine1.n) annotation (Line(points={{18,-31},{18,0},{10,0},
          {10,-12},{-0.333333,-12}}, color={0,0,255}));
  annotation (
