...
equation
  ...
  connect(step4.y, add4.u1)
    annotation (Line(
      ...
      color={0,0,127}));
  connect(order2_Inputs_Outputs1.p, bus.p) annotation (Line(points={{-10.3275,
          0.211802},{-5.66375,0.211802},{-5.66375,0},{0,0}}, color={0,0,255}));
  connect(add31.y, order2_Inputs_Outputs1.vf) annotation (Line(points={{-39.5,
          25},{-35,25},{-35,4.74945},{-29,4.74945}}, color={0,0,127}));
  ...
  connect(add32.y, order2_Inputs_Outputs1.pm) annotation (Line(points={{-39.5,
          -25.0001},{-35,-25.0001},{-35,-4.41685},{-29,-4.41685}}, color={0,0,
          127}));
