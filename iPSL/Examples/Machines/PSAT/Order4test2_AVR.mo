...
model Order4test2_AVR
  ...
  iPSL.Electrical.Controls.PSAT.AVR.AVRtypeIII AVRtypeIII1(s0=0, vf0=1.0641)
...
equation
  connect(AVRtypeIII1.vf, order4_Inputs_Outputs.vf) annotation (Line(
      points={{-56,5},{-47,5},{-47,5},{-37,5}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(const.y, AVRtypeIII1.vs) annotation (Line(points={{-86.5,1},{-79,1}},
                                     color={0,0,127}));
  connect(AVRtypeIII1.v, order4_Inputs_Outputs.v) annotation (Line(points={{-79,10},
          {-87,10},{-87,20},{-10,20},{-10,3},{-16,3}},  color={0,0,127}));
  connect(order4_Inputs_Outputs.pm0, order4_Inputs_Outputs.pm) annotation (Line(
        points={{-35,-11},{-35,-13},{-41,-13},{-41,-5},{-37,-5}},   color={0,0,127}));
  connect(order4_Inputs_Outputs.p, bus.p) annotation (Line(points={{-16,0.04964},
          {-8,0.04964},{-8,0},{0,0}}, color={0,0,255}));
